...
(7,"metric","Perché la metrica ovvia porta a una conclusione falsa",
 ...
 ("I numeri","<div class=\"tbl-scroll\"><table><thead><tr><th>trace_level</th><th><code>run</code></th><th><code>slack</code></th><th>somma delle mediane</th><th>budget</th><th>il resto</th></tr></thead><tbody><tr><td>0</td><td>1984</td><td>8005</td><td>9989</td><td><strong>9991</strong></td><td>9</td></tr><tr><td>1</td><td>1954</td><td>8036</td><td>9990</td><td><strong>9991</strong></td><td>9</td></tr><tr><td>2</td><td>1984</td><td>8006</td><td>9990</td><td><strong>9991</strong></td><td>9</td></tr><tr><td>3</td><td>1999</td><td>7979</td><td>9978</td><td><strong>9977</strong></td><td>23</td></tr></tbody></table></div><p class=\"corr\"><strong>Perché <code>run + slack</code> non dà esattamente il budget.</strong> Il budget <strong>non è la somma delle mediane, ma la mediana della somma</strong>: per ogni singola iterazione si calcola <code>run_i + slack_i</code>, e solo dopo se ne prende la mediana. La mediana non è un operatore lineare, quindi <code>median(a+b) ≠ median(a) + median(b)</code>. Verificato su un run singolo del livello 0: <code>median(run)</code>=1984 e <code>median(slack)</code>=8006 danno 9990, mentre <code>median(run+slack)</code>=9991. La quantità con senso fisico è la seconda — <code>run</code> e <code>slack</code> della <em>stessa</em> iterazione sono accoppiati, l'uno finisce dove l'altro comincia — mentre sommare due mediane prese separatamente mescola iterazioni diverse. La colonna «somma delle mediane» è lì solo per rendere esplicito lo scarto, che vale 1-2 µs.</p><p>La riga del livello 1 è la più istruttiva: <code>run</code> <strong>scende</strong> di 30 µs rispetto al livello 0 (1954 contro 1984), ma <code>slack</code> <strong>sale</strong> di 31 (8036 contro 8005). I due si compensano e il budget resta 9991, identico. Se quei 30 µs fossero stati lavoro reale risparmiato, l'iterazione avrebbe finito prima e lo slack sarebbe cresciuto <em>restando</em> cresciuto: invece il tempo è stato contato altrove.</p><p>Solo il livello 3 sposta davvero il budget, da 9991 a 9977: il resto passa da 9 a 23 µs, quindi il tracing a granularità massima aggiunge <strong>14 µs per iterazione</strong>.</p>"),
 ("Cosa c'è dentro «il resto» — e cosa non c'è","<p>Il resto <strong>non è il tempo di invio degli span</strong>. Scomponendolo con la colonna <code>wu_latency</code>, che rt-app registra a parte:</p><div class=\"tbl-scroll\"><table><thead><tr><th>trace</th><th>resto</th><th>di cui <code>wu_latency</code></th><th>differenza</th></tr></thead><tbody><tr><td>0</td><td>9</td><td>7.4</td><td><strong>1.6</strong></td></tr><tr><td>1</td><td>9</td><td>7.4</td><td><strong>1.6</strong></td></tr><tr><td>2</td><td>9</td><td>7.4</td><td><strong>1.6</strong></td></tr><tr><td>3</td><td>23</td><td>7.5</td><td><strong>15.5</strong></td></tr></tbody></table></div><p>La componente dominante a riposo è la <strong>wakeup latency</strong>: il ritardo fra la scadenza del timer e il momento in cui il kernel rimette davvero in esecuzione il thread. Vale 7.4 µs, è costante a tutti i livelli e non ha niente a che vedere con OpenTelemetry — è il costo del <code>clock_nanosleep</code> più lo scheduling.</p><p>Restano ~1.6 µs di overhead di rt-app stesso, e al livello 3 quei 1.6 diventano 15.5. Quei ~14 µs sono il costo di <strong>creare e chiudere gli span</strong> nel thread: allocare il <code>Recordable</code>, prendere i timestamp, scrivere gli attributi, accodare nella coda del <code>BatchSpanProcessor</code>.</p><p><strong>L'invio non è lì dentro</strong>, e i dati lo dimostrano. Nel blocco 3, a parità di <code>trace_level=3</code> e <code>n_lo=0</code>, cambiando <strong>solo</strong> il processor:</p><pre class=\"eq\">Batch  (export su thread worker separato)   resto =  23 us\nSimple (export sincrono nel thread)         resto = 314 us</pre><p>Se il resto di Batch contenesse già l'invio, i due valori sarebbero simili. Il fattore 13× fra loro <strong>è</strong> il costo dell'invio: con <code>Batch</code> lo paga un altro thread, con <code>Simple</code> lo paga il thread critico.</p>"),
